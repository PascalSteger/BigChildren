...
REM Application Manager for managing application lifecycle for BigChildren
SET APP_JAR_PREFIX=BigChildren

SET APP_NAME=BigChildren
SET FLOW_NAME=WeatherFlow
SET PROCEDURE_NAME=WeeklyMeanProcedure
SET SPARK_NAME=BigChildrenProgram
