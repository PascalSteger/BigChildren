...
REM ## TODO implement weather station data here, read in from input on command line
FOR /F "delims=" %%i IN (%APP_HOME%\resources\MI\612020\alldata) DO (
 SET data=%%i
 SET data=!data:"=\"!
